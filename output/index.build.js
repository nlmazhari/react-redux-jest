...
var _resultsList = __webpack_require__(68);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(22), __webpack_require__(58)(module)))
...
var resultsListReducer = function resultsListReducer() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
	var action = arguments[1];

	switch (action.type) {
		case _constants2.default.CHANGE_GIFS:
			return action.payload;
		case _constants2.default.CLEAR_GIFS:
			return [];
		default:
			return state;
	}
...
exports.default = resultsListReducer;
...
var searchFieldReducer = function searchFieldReducer() {
	...
	switch (action.type) {
		case _constants2.default.SET_SEARCH_FIELD:
			return action.payload;
		case _constants2.default.CLEAR_SEARCH_FIELD:
			return [];
		default:
			return state;
	}
...
var _resultsList = __webpack_require__(74);
...
var _searchField = __webpack_require__(73);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        onClick: function onClick(value) {
            if (value) {
                dispatch((0, _actions.fetchGifs)(value));
                dispatch((0, _actions.setSearchField)(value));
            } else {
                dispatch((0, _actions.clearGifs)());
                dispatch((0, _actions.clearSearchField)());
            }
        }
    };
};
...
var SearchField = function SearchField(_ref) {
    var _ref$onChange = _ref.onChange,
        ...
        _onClick = _ref$onClick === undefined ? function (f) {
        return f;
    } : _ref$onClick;
                        ...
                        _react2.default.createElement(
                            "button",
                            {
                                ...
                                onClick: function onClick() {
                                    return _onClick(queryVal.value);
                                },
...
var _resultsList = __webpack_require__(75);
...
var ResultsList = function ResultsList(_ref) {
    var _ref$gifs = _ref.gifs,
        gifs = _ref$gifs === undefined ? [] : _ref$gifs;
    return _react2.default.createElement(
        "div",
        { className: "gif-wrap" },
        gifs.map(function (item, i) {
            return _react2.default.createElement("img", { className: "gif-img", key: i, src: item.images.preview_gif.url });
        })
    );
};
...
exports.setSearchField = exports.clearSearchField = exports.clearGifs = exports.fetchGifs = exports.changeGifs = undefined;
...
var changeGifs = exports.changeGifs = function changeGifs(Gifs) {
    return {
        type: _constants2.default.CHANGE_GIFS,
        payload: Gifs
    };
};

var fetchGifs = exports.fetchGifs = function fetchGifs(value) {
    return function (dispatch) {

        dispatch({
            type: _constants2.default.FETCH_GIFS
        });

        var url = 'https://api.giphy.com/v1/gifs/search?api_key=deokzgUjxm6QHQdp3H3aca1LSZcCpucc&limit=25&offset=0&rating=Y&lang=en&q=';

        (0, _isomorphicFetch2.default)(url + value).then(function (response) {
...
var clearGifs = exports.clearGifs = function clearGifs() {
    return {
        type: _constants2.default.CLEAR_GIFS
    };
};

var clearSearchField = exports.clearSearchField = function clearSearchField() {
    return {
        type: _constants2.default.CLEAR_SEARCH_FIELD
    };
};

var setSearchField = exports.setSearchField = function setSearchField(keyword) {
    return {
        type: _constants2.default.SET_SEARCH_FIELD,
        payload: keyword
    };
};
